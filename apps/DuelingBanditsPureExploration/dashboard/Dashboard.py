...
class MyAppDashboard(AppDashboard):
    ...
    def most_current_ranking(self, app, butler, alg_label):
        ...
        args = {'exp_uid': app.exp_uid, 'args': {'alg_label': alg_label}}
        model = app.getModel(json.dumps(args))

        args = {'exp_uid': app.exp_uid, 'model': model}
        result = app.getResults(json.dumps(args))[alg_label]
