...
api_interface.add_resource(Experiment, "/experiment", "/experiment/<string:exp_uid>")
...
api_interface.add_resource(
    getQuery, "/experiment/<string:exp_uid>/getQuery", "/experiment/getQuery"
)
...
api_interface.add_resource(Participants, "/experiment/<string:exp_uid>/participants")

from next.api.resources.targets import Targets

api_interface.add_resource(Targets, "/experiment/<string:exp_uid>/targets")
