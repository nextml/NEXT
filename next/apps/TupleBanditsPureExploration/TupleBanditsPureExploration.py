...
problem described in TupleBanditsPureExplorationPrototype.py. See this file for
more info.
"""
...
class TupleBanditsPureExploration(AppPrototype):
  ...
  def processAnswer(self,exp_uid,args_json,db,ell):
    ...
    try:
      ...
      # call processAnswer
      didSucceed,dt = utils.timeit(alg.processAnswer)(resource=rc,targets=target_indices,index_winner=index_winner)
