"""
ConstrainedRegression app of the Online Learning Library for Next.Discovery
author: Kevin Jamieson
last updated: 11/13/2015

ConstrainedRegressionPrototype
...
class ConstrainedRegressionPrototype(object):

  def __init__(self):
    self.app_id = 'ConstrainedRegression'
