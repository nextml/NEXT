...
def load_page(page, exp_uid=None, widget_key=None):
    ...
    return render_template(app_template, host_url=host_url, exp_uid=exp_uid, widget_key=widget_key, num_tries=num_tries), 200, {'Cache-Control':'private, max-age=0, no-cache, no-store'}
