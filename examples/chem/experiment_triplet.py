...
N = 50  # number of targets
FILENAME = 'BS50_trans_2016-3-11.zip'
num_tries = 10  # number of tries

debrief = ('Copy and paste the following cofirmation code to <a'
           'href="https://uwmadison.co1.qualtrics.com/SE/?SID='
           'SV_exoBDHBBpuV3O0B">Google</a>')
instructions = 'Select which molecule is most similar to the top molecule'
...
initExp = {}
initExp['args'] = {}
initExp['args']['n'] = N  # how many targets? (/number of fruits?)
...
# instructions/debreif (they have default values)
initExp['args']['instructions'] = instructions
initExp['args']['debrief'] = debrief
initExp['args']['num_tries'] = num_tries
...
experiment['primary_target_file'] = '{}/'.format(curr_dir) + FILENAME
